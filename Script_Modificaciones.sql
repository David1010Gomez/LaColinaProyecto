...
CREATE TABLE [dbo].[TBL_CLIENTES_DIAN](
	...
	DIGITO_VERIFI VARCHAR(10) NULL
)
ALTER TABLE TBL_SOLICITUD
ADD ID_CLIENTE NUMBER(218,0), FACTURACION_ELECTRONICA VARCHAR(2), ENVIO_DIAN VARCHAR(2), VALORES_VOUCHERS VARCHAR(255), ID_F_DIAN VARCHAR(255)
...
CREATE TABLE [dbo].[TBL_FACTURAS_FALLIDAS_DIAN](
	[ID] [numeric](18, 0) IDENTITY(1,1) NOT NULL PRIMARY KEY,
	[FECHA] [datetime] NULL,
	[ID_SOLICITUD] [numeric](18, 0) NULL,
	[BODY_JSON] [varchar] (4000) NULL,
...
DROP TABLE [dbo].[TBL_FACTURAS_FALLIDAS_DIAN]


---ROLL OUT
ALTER TABLE TBL_SOLICITUD
ADD ID_SOLICITUD_PRINCIPAL NUMERIC(18,0), MESA_DIVIDIDA VARCHAR(2)

---ROLLBACK
ALTER TABLE TBL_SOLICITUD
DROP COLUMN ID_SOLICITUD_PRINCIPAL, MESA_DIVIDIDA
